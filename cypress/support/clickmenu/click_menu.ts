...
>>>>>>> 5652a06c8c7f4452abde3117fac16f5483baf79b
  ...
  // var counter:number=Cypress.$(cy.get('div.container.search-results > ul > li.page-navigator-page-next > a')).length;
  // while(!counter) {
  //   console.log("nextSubmenuCount")
  //   cy.get('div.container.search-results > ul > li.page-navigator-page-next > a').click({multiple: true, force: true, });
  // }
  // else{
  //   cy.get('div.container.search-results > ul > li.page-navigator-page-next > a').click({multiple: true, force: true, });
  // }
